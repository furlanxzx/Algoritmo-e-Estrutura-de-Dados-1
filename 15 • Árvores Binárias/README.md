...
### <mark> Exemplo — quando duas árvores parecidas não são iguais </mark>
...
### <mark> 2.2 - Criando árvores: a função `cria` </mark>
...
### <mark> 2.3 - Acessando e modificando nós existentes </mark>
...
### <mark> 2.4 Completando o `main()`: `imprime` e `libera` </mark>

 Ambas seguem o mesmo padrão recursivo da `cria`: **tratam o caso vazio, e resolvem o resto chamando a si mesmas nas sub-árvores**.
...
### <mark> 2.5 - Bônus: percursos (traversals) </mark>
...
Esse exercício é mais teórico do que de código — vamos raciocinar por partes.
